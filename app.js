(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.BrightonBusesTile = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
var inject = require('../node_modules/cssify');
var css = ".BrightonBusesTileView .flex-row-container {\n  display: -webkit-flex;\n  -webkit-flex-direction: row;\n  -webkit-flex-wrap: nowrap;\n  -webkit-justify-content: flex-start;\n  -webkit-align-content: stretch;\n  -webkit-align-items: stretch;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  justify-content: flex-start;\n  align-content: stretch;\n  align-items: stretch;\n  min-height: 0;\n}\n\n.BrightonBusesTileView .flex-column-container {\n  display: -webkit-flex;\n  -webkit-flex-direction: column;\n  -webkit-flex-wrap: nowrap;\n  -webkit-justify-content: flex-start;\n  -webkit-align-content: stretch;\n  -webkit-align-items: stretch;\n  display: flex;\n  flex-direction: column;\n  flex-wrap: nowrap;\n  justify-content: flex-start;\n  align-content: stretch;\n  align-items: stretch;\n  min-height: 0;\n}\n\n.BrightonBusesTileView {\n  height: 100%;\n}\n\n.BrightonBusesTileView .light {\n  font-weight: 100;\n}\n\n.BrightonBusesTileView .flex100 {\n  -webkit-flex: 1 0 0;\n  flex: 1 0 0;\n}\n\n.BrightonBusesTileView .status-wrapper {\n  -webkit-justify-content: center;\n  justify-content: center;\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  right: 0px;\n  bottom: 0px;\n}\n\n.BrightonBusesTileView .status-container {\n  -webkit-justify-content: center;\n  justify-content: center;\n}\n\n.BrightonBusesTileView .status-container-portrait {\n  -webkit-justify-content: flex-start;\n  -webkit-align-items: center;\n  justify-content: flex-start;\n  align-items: center;\n}\n\n.BrightonBusesTileView .weekday,\n.BrightonBusesTileView .temperature,\n.BrightonBusesTileView .summary {\n  -webkit-flex: 0 0 auto;\n  flex: 0 0 auto;\n}\n\n.BrightonBusesTileView .powered-by {\n  font-size: 8pt;\n  position: absolute;\n  right: 1em;\n  bottom: 1em;\n}\n\n.BrightonBusesTileView .powered-by-link {\n  text-decoration: none;\n}\n";
inject(css, undefined, '_sdhthr');
module.exports = css;
...
},{"./checkRequiredOptions":3,"./dataFetcher":4}],3:[function(require,module,exports){
'use strict';
...
},{"./checkRequiredOptions":3}],5:[function(require,module,exports){
'use strict';
...
},{"./checkRequiredOptions":3}],6:[function(require,module,exports){
'use strict';
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <span class=\"noData\">"
    + container.escapeExpression(((helper = (helper = helpers.noData || (depth0 != null ? depth0.noData : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"noData","hash":{},"data":data}) : helper)))
    + "</span>\n";
  ...
  stack1 = ((helper = (helper = helpers.isLandscape || (depth0 != null ? depth0.isLandscape : depth0)) != null ? helper : alias2),(options={"name":"isLandscape","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.isLandscape) { stack1 = alias4.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  stack1 = ((helper = (helper = helpers.isLandscape || (depth0 != null ? depth0.isLandscape : depth0)) != null ? helper : alias2),(options={"name":"isLandscape","hash":{},"fn":container.noop,"inverse":container.program(6, data, 0),"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.isLandscape) { stack1 = alias4.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer + "          <div class=\"weekday\">"
    + alias5(((helper = (helper = helpers.day || (depth0 != null ? depth0.day : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"day","hash":{},"data":data}) : helper)))
    + "</div>\n          <div class=\"temperature vz-custom__tile--highlighted-color\" data-targetfontsize=\"40\">"
    + alias5(((helper = (helper = helpers.temperature || (depth0 != null ? depth0.temperature : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"temperature","hash":{},"data":data}) : helper)))
    + "</div>\n          <div class=\"summary\">"
    + alias5(((helper = (helper = helpers.summary || (depth0 != null ? depth0.summary : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"summary","hash":{},"data":data}) : helper)))
    + "</div>\n        </div>\n      </div>\n      <div class=\"powered-by\">Powered by <a class=\"powered-by-link vz-custom__tile--highlighted-color\" href=\"//forecast.io/\" target=\"_blank\">Forecast</a></div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    var helper;

  return "  <div class=\"status-wrapper flex100 flex-row-container\">\n    <svg class=\"flex100\">\n      <svg class=\"weather-icon vz-custom__tile--highlighted-fill\" viewBox=\"0 0 256 256\" preserveAspectRatio=\"xMaxYMid meet\">\n        <use xlink:href=\""
    + container.escapeExpression(((helper = (helper = helpers.statusIcon || (depth0 != null ? depth0.statusIcon : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"statusIcon","hash":{},"data":data}) : helper)))
    + "#use-hook\"></use>\n      </svg>\n    </svg>\n    <div class=\"status-container flex100 flex-column-container light\">\n";
},"6":function(container,depth0,helpers,partials,data) {
    var helper;

  return "      <div class=\"status-wrapper flex100 flex-column-container\">\n        <svg class=\"flex100\">\n          <svg class=\"weather-icon vz-custom__tile--highlighted-fill\" viewBox=\"0 0 256 256\" preserveAspectRatio=\"xMidYMax meet\">\n            <use xlink:href=\""
    + container.escapeExpression(((helper = (helper = helpers.statusIcon || (depth0 != null ? depth0.statusIcon : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"statusIcon","hash":{},"data":data}) : helper)))
    + "#use-hook\"></use>\n          </svg>\n        </svg>\n        <div class=\"status-container-portrait flex100 flex-column-container light\">\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=helpers.blockHelperMissing, buffer = 
  "<div class=\"tile-main flex-column-container\" data-targetfontsize=\"22\">\n";
  stack1 = ((helper = (helper = helpers.noData || (depth0 != null ? depth0.noData : depth0)) != null ? helper : alias2),(options={"name":"noData","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.noData) { stack1 = alias4.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  stack1 = ((helper = (helper = helpers.noData || (depth0 != null ? depth0.noData : depth0)) != null ? helper : alias2),(options={"name":"noData","hash":{},"fn":container.noop,"inverse":container.program(3, data, 0),"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.noData) { stack1 = alias4.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer + "    </div>\n";
},"useData":true});

},{"hbsfy/runtime":29}],31:[function(require,module,exports){
'use strict';
...
},{"../css/BrightonBusesTileView.css":1,"../lib/AutoUpdate":2,"../lib/dataParser":5,"../lib/resizeHelper":6,"../templates/busestile.html":30,"debounce":8}]},{},[31])(31)
});